...
const CoffeeIntro = ()=>
{
    return (
        <Container>
            ...
            <body>
                <Row><Col>Gaggiuino is a community-driven project that aims to enhance the Gaggia Classic espresso machine by adding a microcontroller to regulate temperature and pressure.</Col></Row>
