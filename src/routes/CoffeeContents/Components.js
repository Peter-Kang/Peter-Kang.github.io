    ...
    return (
        <Container>
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2741.png" height="25%" width="25%" alt="On The Top left is the power supply that converts live and neutral to 5v and ground" />
            ...
            <br />
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2738.png" height="25%" width="25%" alt="On The Top left is the power supply that converts live and neutral to 5v and ground" />
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2740.png" height="25%" width="25%" alt="Nexton 2.4 inch Discover display" />
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2743.png" height="25%" width="25%" alt="Thermal Coupler" />
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2739.png" height="25%" width="25%" alt="Solid State Relay Switch" />
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2867.png" height="25%" width="25%" alt="T Fitting" />
            ...
            <figure className="figure text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/IMG_2868.png" height="25%" width="25%" alt="Pressure Sensor" />
            ...
            <figure className="figure  text-center">
                <Image className="alignmnet-center figure-img img-fluid" src="./CoffeeMachineImages/dimmer.jpg" height="25%" width="25%" alt="dimmer" />
