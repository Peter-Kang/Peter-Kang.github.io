...
const GaggiuinoComponents = ()=>
{
    ...
    <Container>
        ...
        <body>
            ...
            At the time the parts where ordered the nano was not deprecated. Upgrading the to STM32 Blackpill with added features would be the best path forward. It does add a significant amount of <a href="https://gaggiuino.github.io/#/?id=features">features</a>.
            <br/>
            <figure class="figure" className="text-center">
        ...
        <body>
            Giving the machine pressure control will also help in better setting the extraction. Pressure is measured in bars. 
            ...
            Fitting the pump sensor into the existing pump set up requires a T fitting. 
            <figure class="figure" className="text-center">
